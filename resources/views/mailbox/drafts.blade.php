...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="/mailbox"><i class="fa fa-envelope"></i> Buzón</a></li>
            <li class="active"><i class="fa fa-file-text-o"></i> Archivados</li>
        </ol>
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body no-padding">
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li class="active"><a href="/mailbox/drafts"><i class="fa fa-file-text-o"></i>
                                    Archivados</a></li>
                        </ul>
                    </div>
                    <!-- /.box-body -->
                                ...
                                @foreach($mails as $mail)
                                    <tr>
                                        <td class="mailbox-name"><a
                                                    href="/mailbox/{{$mail->id}}/edit">{{ $mail->name . ' ' . $mail->lastname }}</a>
                                        </td>
                                        ...
                                        <td>
                                            <a href="/mailbox/{{ $mail->id }}/edit" class="btn btn-xs btn-default"
                                               data-toggle="tooltip" data-placement="top" title="Ver">
                                                <span class="fa fa-eye"></span>
                                            </a>
                                            <form class="display_inline_block"
                                                  action="{{ route('mailbox.destroy', $mail->id) }}"
                                                  method="POST">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
